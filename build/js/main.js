...
/***/ function(module, exports, __webpack_require__) {
	...
	var _beginScreen = __webpack_require__(216);

	var _beginScreen2 = _interopRequireDefault(_beginScreen);
	...
	var App = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(_reactRouter.Route, { path: '/begin', component: _beginScreen2.default }),
	      React.createElement(_reactRouter.Route, { path: '/timer', component: _timer2.default }),
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        'button',
	        { className: 'start-button', onClick: this.beginEval },
	        'Take Test'
	      )
	    );
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Begin = _react2.default.createClass({
	  displayName: 'Begin',


	  startQuiz: function startQuiz() {
	    _reactRouter.browserHistory.push('/timer');
	  },
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        'button',
	        { className: 'start-button', onClick: this.startQuiz },
	        'Begin Evaluation'
	      )
	    );
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var InitializeTimer = _react2.default.createClass({
	  displayName: "InitializeTimer",
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        "span",
	        null,
	        this.state.secondsElapsed >= 60 ? 1 : 0
	      ),
	      _react2.default.createElement(
	        "span",
	        null,
	      ...
	      _react2.default.createElement(
	        "span",
	        null,
	        this.state.secondsElapsed >= 10 ? "" : 0
	      ),
	      _react2.default.createElement(
	        "span",
	        null,
	        this.state.secondsElapsed >= 60 ? "00" : this.state.secondsElapsed
	      )
	    );
	  }
	});
	...
	var Timer = _react2.default.createClass({
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      "div",
	      { className: "quiz-window" },
	      _react2.default.createElement(InitializeTimer, { timeout: 0 })
	    );
	  }
	});
